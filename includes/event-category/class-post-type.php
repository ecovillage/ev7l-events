 ...
 * @since 0.0.1
 */
class EV7L_Event_Category {

	/**
   * Plugin version, used for cache-busting of style and script file references.
   * TODO: Evaluate in how far this gets registered multiple times.
   *       Probably we want one registation handler only
	 *
	 * @since 0.0.1
	 *
